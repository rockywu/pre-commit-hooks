...
* 查阅：[Standard](https://github.com/standard/standard/blob/master/docs/RULES-zhcn.md) -- [WebStorm配置](https://github.com/standard/standard/blob/master/docs/webstorm.md)

* 查阅：[Eslint:recommended](http://eslint.cn/docs/user-guide/configuring#using-eslintrecommended)

* 查阅：[plugin:vue/recommended](https://github.com/vuejs/eslint-plugin-vue)
